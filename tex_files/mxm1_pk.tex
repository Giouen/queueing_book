...
The remainder of the section aims to derive two cornerstones of queueing theory.
The first is the expected  time an item spends in a queue:
...
\end{equation}
Thus, to compute the average number of items in the system, we only need to know the first and second moments (or the variance) of the batch size $B$.
